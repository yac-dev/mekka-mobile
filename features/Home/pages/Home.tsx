          ...
          <View style={{ flex: 9 }}>
              ...
              <ScrollView horizontal contentContainerStyle={{ paddingRight: 10 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <StatBox
                    title='Status'
                    icon={
                      <VectorIcon.MI name='public' color={'rgb(150,150,150)'} size={15} style={{ marginRight: 5 }} />
                    }
                  ...
                  <StatBox
                    title='Content'
                    icon={
                      <VectorIcon.II name='camera' color={'rgb(150,150,150)'} size={15} style={{ marginRight: 5 }} />
                    }
                    value={
            ...
            <ScrollView>
              ...
              <View style={{ flexDirection: 'column', paddingVertical: 10 }}>
                ...
                <View
                  style={{ width: '90%', backgroundColor: 'rgb(80,80,80)', height: 0.5, alignSelf: 'center' }}
                ></View>
              </View>
              <View style={{ paddingLeft: 15, paddingTop: 10 }}>
