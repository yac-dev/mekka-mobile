...
const ReportPost = (props) => {
  ...
  useEffect(() => {
    props.navigation.setOptions({
      headerRight: () => (
        <TouchableOpacity onPress={() => onDonePress()} disabled={isSubmitDisabled ? true : false}>
          <Text
            style={{
      ...
      <ScrollView>
        <View style={{ paddingLeft: 30, paddingRight: 30, paddingTop: 20, paddingBottom: 20 }}>
          ...
          <Text style={{ textAlign: 'center', color: 'rgb(180, 180, 180)' }}>
            Why are you reporting this post? Please choose a issue option down below. Your report will be sent to
            developer.
          </Text>
        </View>
